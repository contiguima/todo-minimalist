...
export default function Home() {
  return (
    ...
    <div className="flex flex-col min-h-screen text-white text-wrap justify-center p-10">
      ...
      <button className="self-center w-min-250 p-4 sm:p-6 rounded-full border-2 border-white text-lg sm:text-xl md:text-2xl font-light my-12 whitespace-nowrap   hover:bg-gradient-to-r  hover:from-silver-1 hover:to-silver-2">Take me to my <i>Dashboard</i></button>
    </div>
    <Dashboard/>
    </>
  );
